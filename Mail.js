class Mail{
    ...
    sendMail(){
       this.from.position(windowWidth/4-40,windowHeight/2+55);
       this.myTextArea.position(windowWidth/4-40,windowHeight/2+100);
       this.button.position(windowWidth/4-20,windowHeight/2+265);
